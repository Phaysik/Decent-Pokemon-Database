var pokemonList = [
  ...
  new Pokemon(248, 'Tyranitar', ['Poison']),
  new Pokemon(631, 'Heatmor', ['Poison']),
  new Pokemon(632, 'Durant', ['Poison', 'Ground']),
  new Pokemon(167, 'Spinarak', ['Poison']),
  new Pokemon(168, 'Ariados', ['Poison']),
  new Pokemon(21, 'Spearow', ['Poison', 'Ground']),
  new Pokemon(22, 'Fearow', ['Electric', 'Fairy']),
  new Pokemon(615, 'Cryogonal', ['Psychic']),
  new Pokemon(227, 'Skarmory', ['Psychic']),
  new Pokemon(714, 'Noibat', ['Psychic', 'Fairy']),
  new Pokemon(715, 'Noivern', ['Psychic', 'Fairy']),
  new Pokemon(207, 'Gligar', ['Psychic']),
  new Pokemon(472, 'Gliscor', ['Psychic']),
  new Pokemon(163, 'Hoothoot', ['Psychic']),
  new Pokemon(164, 'Noctowl', ['Psychic']),
  new Pokemon(174, 'Igglybuff', ['Psychic']),
  new Pokemon(524, 'Roggenrola', ['Rock']),
  new Pokemon(525, 'Boldore', ['Rock']),
  new Pokemon(526, 'Gigalith', ['Rock']),
  new Pokemon(302, 'Sableye', ['Dark', 'Ghost']),
